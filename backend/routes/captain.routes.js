...
router.post(
  ...
  [
    ...
    body('vehicle.vehicleType').isIn(['car', 'motorcycle', 'auto', 'cng', 'bicycle']).withMessage('Invalid vehicle type'),
  ],
  captainController.registerCaptain
);

router.post('/verify-otp', captainController.verifyCaptainOTP);
